...
<p align="center">
  <a href="https://github.com/a182860089-pixel/codex-witcher-lm/releases/tag/v0.3.14"><strong>下载 v0.3.14</strong></a>
  ·
...
> 0.3.14 只发布 Windows x64 安装包，尚未代码签名。安装前请核对 Release 中的 SHA-256。

| 系统 | 安装包 | 安装方法 |
| --- | --- | --- |
| Windows x64（已在 Windows 11 验证） | [下载 EXE](https://github.com/a182860089-pixel/codex-witcher-lm/releases/download/v0.3.14/Codex.Provider.Switcher_0.3.14_Windows-x64-Setup.exe) | 双击安装；若 SmartScreen 出现，核对校验值后选择“更多信息 → 仍要运行” |
...
```powershell
Get-FileHash '.\Codex.Provider.Switcher_0.3.14_Windows-x64-Setup.exe' -Algorithm SHA256
```
...
将结果与 [v0.3.14 Release](https://github.com/a182860089-pixel/codex-witcher-lm/releases/tag/v0.3.14) 中的说明对比。

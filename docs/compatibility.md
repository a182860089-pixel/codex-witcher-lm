...
| Windows | x86_64 | Version 0.3.21 is the current Windows installer from [`a182860089-pixel/codex-witcher-lm`](https://github.com/a182860089-pixel/codex-witcher-lm/releases/tag/v0.3.21) (`Codex.Provider.Switcher_0.3.21_Windows-x64-Setup.exe`, SHA-256 `a00f471f9e5675d078eda23c1b6fb3ce560d8269d052aa1fac473ed85c5d1355`). It keeps the 0.3.20 SSE/error mapping, and additionally retries Grok plan sentences after a tool result even when the plan is only in the current SSE output; live bash `ls`/`find`/`pwd`/`cat` commands are rewritten to PowerShell. Version 0.3.20 remains the previous published installer (`Codex.Provider.Switcher_0.3.20_Windows-x64-Setup.exe`, SHA-256 `d59e3bde9f4e7ad114dbd7f24ecd77575a4128e8b322ed053264759fdf508327`). Version 0.3.19 remains available (`Codex.Provider.Switcher_0.3.19_Windows-x64-Setup.exe`, SHA-256 `9f49e71939a98c988392dd3e414a8f7859179dee4b657053f3b23dffa52f00f4`). Version 0.3.4 also passed public native Web/Rust/Tauri tests and NSIS package smoke | Complete interactive official OAuth switching, DACL/durability, cleanup/uninstall, signing, and a live turn on an upstream model with an available channel |

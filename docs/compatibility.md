...
| Windows | x86_64 | Version 0.3.14 is published from [`a182860089-pixel/codex-witcher-lm`](https://github.com/a182860089-pixel/codex-witcher-lm/releases/tag/v0.3.14) (`Codex.Provider.Switcher_0.3.14_Windows-x64-Setup.exe`, SHA-256 `263fe63b324a791e2cf08d24ed042deb7266800f7492d1160b9dcfa1b413e0dd`). Version 0.3.4 also passed public native Web/Rust/Tauri tests and NSIS package smoke | Complete interactive official OAuth switching, DACL/durability, cleanup/uninstall, signing, and a live turn on an upstream model with an available channel |

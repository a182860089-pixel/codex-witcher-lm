...
| Windows | x86_64 | Version 0.3.22 is the current Windows installer from [`a182860089-pixel/codex-witcher-lm`](https://github.com/a182860089-pixel/codex-witcher-lm/releases/tag/v0.3.22) (`Codex.Provider.Switcher_0.3.22_Windows-x64-Setup.exe`, SHA-256 `2eee0ee5541de0f80869210a8ecda3eb7cc9cc0b4729af96d2c751cf316c16f3`). It keeps the 0.3.21 Grok plan retries and Windows exec rewrite, and additionally lets saved connections set a 64k–2M context window (default 250k), migrates legacy hardcoded 128k profiles to 250k, and continues the turn after leftover inspection plans such as “原仓库继续，直接读样式并看截图”. Version 0.3.21 remains the previous published installer (`Codex.Provider.Switcher_0.3.21_Windows-x64-Setup.exe`, SHA-256 `a00f471f9e5675d078eda23c1b6fb3ce560d8269d052aa1fac473ed85c5d1355`). Version 0.3.20 remains available (`Codex.Provider.Switcher_0.3.20_Windows-x64-Setup.exe`, SHA-256 `d59e3bde9f4e7ad114dbd7f24ecd77575a4128e8b322ed053264759fdf508327`). Version 0.3.4 also passed public native Web/Rust/Tauri tests and NSIS package smoke | Complete interactive official OAuth switching, DACL/durability, cleanup/uninstall, signing, and a live turn on an upstream model with an available channel |
